...
- 계획의 SoT
- slice 정의, 선후관계, planning 상태, workspace binding,
  기본 AC, abstract ownership / verification 경계를 가진다
...
- `planning_status`는 backlog/planning 준비 상태다
- `workspace_binding`은 branch/worktree/agent 할당 같은 planning binding이다
